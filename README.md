...
## Data de Entrega
  ...
  - Data de entrega para avaliação final do projeto: `23/02/2022 14:00`.
...
4. Crie na raiz do projeto os arquivos que você precisará desenvolver:
  * Verifique que você está na raiz do projeto
    * Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/joaozinho/code/**sd-020-a-project-todo-list**_
...
7. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-020-a-project-todo-list/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-020-a-project-todo-list/pulls) e confira que o seu _Pull Request_ está criado
